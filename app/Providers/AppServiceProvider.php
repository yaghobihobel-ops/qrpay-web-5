...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton(ProviderOverrideRepository::class, function () {
            return new ProviderOverrideRepository();
        });

        $this->app->singleton(DomainInstrumentation::class, function ($app) {
            return new DomainInstrumentation($app->make(ProviderOverrideRepository::class));
        });
    }
