@if (admin_permission_by_name("admin.mobile.topup.method.manual.update"))
    <div id="edit-category" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.mobile.topup.method.manual.update') }}">
                    @csrf
                    @method("PUT")
