@if (admin_permission_by_name("admin.mobile.topup.method.manual.store"))
    <div id="category-add" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.mobile.topup.method.manual.store') }}">
                    @csrf
