@if (admin_permission_by_name("admin.bill.pay.method.manual.category.store"))
    <div id="category-add" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.bill.pay.method.manual.category.store') }}">
                    @csrf
