...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.mobile.topup.method.automatic.api.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                    ...
                    <div class="col-xl-12 col-lg-12 form-group configForm">
                        <div class="row" >
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 form-group">
                                ...
                                <div class="input-group append">
                                    <span class="input-group-text"><i class="las la-link"></i></span>
                                    <input type="text" class="form--control" id="referralURL" value="{{ setRoute('global.mobile.topup.webhook') }}" readonly>
