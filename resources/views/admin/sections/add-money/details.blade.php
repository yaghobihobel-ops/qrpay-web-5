            ...
            <div class="row align-items-center mb-10-none">
                ...
                <div class="col-xl-4 col-lg-4 form-group">
                    <div class="user-profile-thumb">
                        <img src="{{ get_gateway_image($data->currency->payment_gateway_id??0) }}" alt="payment">
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list two">
                        ...
                        <li class="two">{{ __("After Charge") }}: <span>{{ get_amount(@$data->payable,$data->currency->currency_code??get_default_currency_code(),$precision) }} </span></li>
                        <li class="three">{{ __("Rate") }}: <span>1 {{ get_default_currency_code() }} = {{ get_amount(@$data->currency->rate??1,$data->currency->currency_code??get_default_currency_code(),$precision) }}</span></li>
